...
In the [second part]({% post_url 2019-06-13-codable-by-example-part-2 %}) of this series, we'll see how to decode more complex JSON payloads containing nested arrays.
