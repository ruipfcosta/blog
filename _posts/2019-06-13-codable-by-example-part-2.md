...
This article is the second part of my previous article [Codable by Example]({% post_url 2019-06-10-codable-by-example %}). This time we'll be covering a few more scenarios when decoding JSON payloads into Swift types.
